...
fun KtReturnExpression.getTargetFunctionDescriptor(context: BindingContext): FunctionDescriptor? {
    ...
    val containingFunctionDescriptor =
        DescriptorUtils.getParentOfType(declarationDescriptor, FunctionDescriptor::class.java, false) ?: return null
...
fun KtExpression.isUnreachableCode(context: BindingContext): Boolean = context[UNREACHABLE_CODE, this]!!
...
fun KtTypeElement.getAbbreviatedTypeOrType(context: BindingContext): KotlinType? = when (val parent = parent) {
